...
%JAVACMD% %JAVA_OPTS% -server -Xmx1G -Xms1G -classpath %CLASSPATH% -Dapp.name="app" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" com.alan.springboot.App %CMD_LINE_ARGS%
